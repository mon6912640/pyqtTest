...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.btnAbout, 3, 3, 1, 1)
        ...
        self.tfPg = QtWidgets.QLabel(self.centralwidget)
        self.tfPg.setAlignment(QtCore.Qt.AlignCenter)
        self.tfPg.setObjectName("tfPg")
        self.gridLayout.addWidget(self.tfPg, 5, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tfPg.setText(_translate("MainWindow", "TextLabel"))
